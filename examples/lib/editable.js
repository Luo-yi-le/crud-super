...
export default {
    ...
    methods: {
        ...
        onRowContextMenu(row, column, event, store) {
            ...
            const { refresh, rowEdit, rowDelete, rowView, permission, getPermission, contextMenu } = this.crud;
            const cm =
        ...
        return (
            this.table.visible && (
                <div class="crud-data-table">
                    <el-form {...this.form} model={formModel}></el-form>
                    {
                        refresh && (<el-table
                            ref="table"
                            data={data}
